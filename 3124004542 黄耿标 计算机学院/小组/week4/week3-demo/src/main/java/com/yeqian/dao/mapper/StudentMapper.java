...
public interface StudentMapper {
     ...
     * @return
     */
    @Select("select * from student where student_name = #{studentName} and id != #{id}")
    Student selectStudentByNameExceptId(@Param("studentName") String studentName, @Param("id") Integer id);
